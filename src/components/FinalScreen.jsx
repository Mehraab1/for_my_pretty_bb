...
export default function FinalScreen() {
  ...
  const proposalMessage = `You came into my life unexpectedly and that’s the best thing that happened to me. You brought colors to my ordinary days, warmth to my silence, and a smile to my face.  

Each passing day, my feelings for you grow more and more. Every night I look forward to next day to spend more time with you. You aspire me to work hard and have a meaningful life.

I had long ago given up on love, thinking its not something meant for me but ig it just wasn’t the right time or person back then. I hope we are meant for each other and God blesses us and ships us together. I want you to be the one and only for me.
